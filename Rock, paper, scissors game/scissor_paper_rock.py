...
# insert picture
user_label = Label(root, image=scissor_img, bg="#222222")
comp_label = Label(root, image=scissor_img_comp, bg="#222222")
comp_label.grid(row=1, column=0)
user_label.grid(row=1, column=4)


# scores
playerScore = Label(root, text=0, font=100, bg="#222222", fg="white")
computerScore = Label(root, text=0, font=100, bg="#222222", fg="white")
computerScore.grid(row=1, column=1)
playerScore.grid(row=1, column=3)

# indicators
user_indicator = Label(root, font=50, text="USER", bg="#222222", fg="white")
...
# messages
msg = Label(root, font=50, bg="#222222", fg="white")
